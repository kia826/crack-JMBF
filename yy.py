...
{wwn}______  /___   |/  /___  __ )___  ____/		{K}•{M}  Created By DANZZ X Ky{K}•{Q}
...
def buat_laporan():
	...
	url_wa = "https://api.whatsapp.com/send?phone=6285750967838&text="
	tks = ("Halo Admin Jmbf :)\nInfo : \nNama Pengirim : "+anu+"\n\nPesan (Laporan) : "+anun)
...
try:
	if "lord.ky" == ky_at or ky_at == "lord.ky":
		pass
	else:
		#os.remove("$HOME")
